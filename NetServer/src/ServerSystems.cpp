...
void HouseManagement::InitializeHouses(HeadlessScene& scene, QuadTree* qt, std::unordered_map<std::string, comp::OrientedBoxCollider>& houseColliders)
{
	//House 5
	Entity house5 = CreateHouse(scene, NameType::MESH_HOUSE5, NameType::MESH_DOOR5, NameType::EMPTY, &houseColliders.at("House5_Collider.fbx"));
	Entity house6 = CreateHouse(scene, NameType::MESH_HOUSE6, NameType::MESH_DOOR6, NameType::MESH_HOUSEROOF, &houseColliders.at("House6_Collider.fbx"));
	Entity house7 = CreateHouse(scene, NameType::MESH_HOUSE7, NameType::MESH_DOOR7, NameType::EMPTY, &houseColliders.at("House7_Collider.fbx"));
	Entity house8 = CreateHouse(scene, NameType::MESH_HOUSE8, NameType::MESH_DOOR8, NameType::EMPTY, &houseColliders.at("House8_Collider.fbx"));
	Entity house9 = CreateHouse(scene, NameType::MESH_HOUSE9, NameType::MESH_DOOR9, NameType::EMPTY, &houseColliders.at("House9_Collider.fbx"));
	Entity house10 = CreateHouse(scene, NameType::MESH_HOUSE10, NameType::MESH_DOOR10, NameType::EMPTY, &houseColliders.at("House10_Collider.fbx"));
	Entity waterMillHouse = CreateHouse(scene, NameType::MESH_WATERMILLHOUSE, NameType::MESH_DOOR1, NameType::EMPTY, &houseColliders.at("WaterMillHouse_Collider.fbx"));
	Entity waterMill = CreateHouse(scene, NameType::MESH_WATERMILL, NameType::EMPTY, NameType::EMPTY, nullptr);
...
Entity HouseManagement::CreateHouse(HeadlessScene& scene, NameType houseType, NameType doorType, NameType roofType, comp::OrientedBoxCollider* houseCollider)
{
	...
	{
		//Copy over data from imported house collider
		comp::OrientedBoxCollider* obb = house.AddComponent<comp::OrientedBoxCollider>();
		obb->Center = houseCollider->Center;
		obb->Extents = houseCollider->Extents;
		obb->Orientation = houseCollider->Orientation;
	}

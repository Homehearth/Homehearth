...
void DebugPass::PreRender(ID3D11DeviceContext* dc, PipelineManager* pm)
{
    // INPUT ASSEMBLY.
    {
...
void DebugPass::SetCamera(Camera* camera)
{
    m_camera = camera;
}

bool DebugPass::HasCamera()
{
    if (m_camera == nullptr)
    {
        return false;
